...
export interface CrossChainMessageInterface extends utils.Interface {
  functions: {
    ...
    "sendMessage(uint256,string)": FunctionFragment;
  ...
  events: {
    "CrossChainMessageEvent(string)": EventFragment;
    "CrossChainMessageRevertedEvent(string)": EventFragment;
    "OwnershipTransferStarted(address,address)": EventFragment;
    "OwnershipTransferred(address,address)": EventFragment;
  };

  getEvent(nameOrSignatureOrTopic: "CrossChainMessageEvent"): EventFragment;
  getEvent(
    nameOrSignatureOrTopic: "CrossChainMessageRevertedEvent"
  ): EventFragment;
  getEvent(nameOrSignatureOrTopic: "OwnershipTransferStarted"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "OwnershipTransferred"): EventFragment;
}

export interface CrossChainMessageEventEventObject {
  arg0: string;
}
export type CrossChainMessageEventEvent = TypedEvent<
  [string],
  CrossChainMessageEventEventObject
>;

export type CrossChainMessageEventEventFilter =
  TypedEventFilter<CrossChainMessageEventEvent>;

export interface CrossChainMessageRevertedEventEventObject {
  arg0: string;
}
export type CrossChainMessageRevertedEventEvent = TypedEvent<
  [string],
  CrossChainMessageRevertedEventEventObject
>;

export type CrossChainMessageRevertedEventEventFilter =
  TypedEventFilter<CrossChainMessageRevertedEventEvent>;
...
export interface CrossChainMessage extends BaseContract {
  ...
  filters: {
    "CrossChainMessageEvent(string)"(
      arg0?: null
    ): CrossChainMessageEventEventFilter;
    CrossChainMessageEvent(arg0?: null): CrossChainMessageEventEventFilter;

    "CrossChainMessageRevertedEvent(string)"(
      arg0?: null
    ): CrossChainMessageRevertedEventEventFilter;
    CrossChainMessageRevertedEvent(
      arg0?: null
    ): CrossChainMessageRevertedEventEventFilter;
